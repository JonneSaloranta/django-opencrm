...
urlpatterns = [
    ...
    path("companies/<int:pk>/edit/", views.CompanyUpdateView.as_view(), name="edit_company"),
    path("companies/<int:pk>/delete/", views.CompanyDeleteView.as_view(), name="delete_company"),
    ...
    path("companytypes/<int:pk>/edit/", views.CompanytypeUpdateView.as_view(), name="edit_companytype"),
    path("companytype/<int:pk>/delete/", views.CompanyTypeDeleteView.as_view(), name="delete_companytype"),
